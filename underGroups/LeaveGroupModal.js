      ...
      <TouchableWithoutFeedback onPress={() => {}}>
        <View style={styles.modalContent}>
          ...
          <View style={ styles.modalDescriptionContainer }>
            <Text style={ styles.modalDescriptionText }>Are you sure you want to leave this group?</Text>
          </View>
          ...
          <View style={ styles.optionsContainer }>
            ...
            <View style={ styles.confirmOptionContainer }>
              <TouchableOpacity onPress={handleLeave} style={ styles.confirmOption }>
                <Text style={ styles.confirmOptionText }>Leave</Text>
              </TouchableOpacity>
            </View>
          </View>
